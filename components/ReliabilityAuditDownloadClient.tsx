...
import s from '@/styles/reliability-audit-download.module.css';

const PDF_URL = '/downloads/50-Point-AI-Reliability-Audit.pdf';

export default function ReliabilityAuditDownloadClient() {
  return (
      ...
      <main className={s.main}>
        <section className={s.confirm}>
          ...
          <p className={s.confirmDesc}>
            Your copy of The 50-Point AI Reliability Audit is ready. Click below to
            download the PDF — it&apos;s yours to keep, print, and run with your team.
          </p>
          <a className={s.btnPrimary} href={PDF_URL} download="50-Point-AI-Reliability-Audit.pdf">
